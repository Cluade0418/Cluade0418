...
--->
[![My Skills](https://skillicons.dev/icons?i=java,anaconda,nodejs,azure,bash,blender,css,docker,,eclipse,github,grafana,gtml,js,linux,matlab,mysql,nextjs,nodejs,nuxtjs,obsidian,php,pycharm,py,pytorch,raspberrypi,visualstudio,vscode,vue,figma&theme=light)](https://skillicons.dev)
